...
![img](D:\Java\笔记\图片\1-06【并发】\12-1线程池.png)
...
如果线程到达 `maximumPoolSize` 仍然有新任务这时会执行拒绝策略。 jdk拒绝策略 提供了 4 种实现

![img](D:\Java\笔记\图片\1-06【并发】\12-3拒绝策略.png)
...
![](D:\Java\笔记\图片\1-06【并发】\12-4自定义拒绝策略)

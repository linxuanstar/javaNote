...
1. 添加lombok依赖。这是Maven和Gradle里面的依赖坐标

   ```xml
   <dependency>
       <groupId>org.projectlombok</groupId>
       <artifactId>lombok</artifactId>
       <!-- 如果是SpringBoot项目，那么版本可以不用写，因为SpringBoot中已经管理了lombok的版本。-->
...
Lombok 只是简化模型类的编写，如果只想要有 name 和 password 的构造函数，那就自行编写：
...
<img src="..\图片\1-00【Java基础】\7继承.png" />
...
<img src="..\图片\1-00【Java基础】\8super和this.png" />
...
<img src="..\图片\1-00【Java基础】\9静态原理.png" />
...
<img src="..\图片\1-00【Java基础】\12-1版本特性.png" />

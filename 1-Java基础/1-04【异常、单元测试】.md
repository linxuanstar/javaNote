...
![](D:\Java\笔记\图片\1-04【异常、单元测试】\1异常分类.png)
...
![异常的产生过程解析](..\图片\1-04【异常、单元测试】\1-1.4 异常的产生过程解析.png)
...
![](D:\Java\笔记\图片\1-04【异常、单元测试】\4Junit.png)
...
* 一般我们会使用断言操作来处理结果，`Assert.assertEquals(期望的结果，result);`。如果结果与我们期望的结果不同，会抛出异常，变成红色。

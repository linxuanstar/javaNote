...
![](D:\Java\笔记\图片\1-16【JVM4-类加载、编译运行处理】\1-1.png)
...
所以Static 变量在JDK 7以前是存储与`instanceKlass`末尾。但在JDK 7及以后就存储在`_java_mirror`末尾了

![](D:\Java\笔记\图片\1-16【JVM4-类加载、编译运行处理】\-12方法区.png)
...
![](D:\Java\笔记\图片\1-16【jvm】\17-1.png)

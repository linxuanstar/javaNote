...
MyBatisPlus（简称MP）是基于MyBatis框架基础上开发的增强型工具，旨在简化开发、提高效率。MyBatisPlus的官网为:`https://mp.baomidou.com/`，去访问`https://mybatis.plus`会发现访问不到。对于MP的学习，我们可以参考着官方文档来进行学习，里面都有详细的代码案例。
...
2. 创建SpringBoot工程，选择配置使用的技术：MySQL。由于MP并未被收录到idea的系统内置配置，无法直接选择加入，需要手动在pom.xml中配置添加
...
3. pom.xml补全依赖
   ...
   ![1631206757758](..\图片\4-05【MyBatisPlus】/1-1.png)
...
7. 编写引导类
   ...
   1. 方案一：在Dao接口上添加`@Mapper`注解，并且确保Dao处在引导类所在包或其子包中。该方案的缺点是需要在每一Dao接口中添加注解
   2. 方案二：在引导类上添加`@MapperScan`注解，其属性为所要扫描的Dao所在包。该方案的好处是只需要写一次，则指定包下的所有Dao接口都能被扫描到，`@Mapper`就可以不写。
...
![1631018877517](..\图片\4-05【MyBatisPlus】/1-2.png)
...
2. 设置分页拦截器
   ...
   ![1631208030131](..\图片\4-05【MyBatisPlus】/1-3.png)
...
![](D:\Java\笔记\图片\4-05【MyBatisPlus】\2-1雪花算法)
...
![1631245676125](..\图片\4-05【MyBatisPlus】/1-4.png)
...
![1631245757169](..\图片\4-05【MyBatisPlus】/1-5.png)
...
![1631246806130](..\图片\4-05【MyBatisPlus】/1-6.png)
...
![1631246997190](..\图片\4-05【MyBatisPlus】/1-7.png)
...
![1631247188218](..\图片\4-05【MyBatisPlus】/1-8.png)
...
4. 执行更新操作
   ...
   ![1631253302587](..\图片\4-05【MyBatisPlus】/1-9.png)
...
![1631254075651](..\图片\4-05【MyBatisPlus】/1-10.png)

那我们就想，如果我想做一个Book模块的开发，是不是只需要将红色部分的内容全部更换成`Book`即可，如：

![1631254119948](..\图片\4-05【MyBatisPlus】/1-11.png)
...
![1631254344180](..\图片\4-05【MyBatisPlus】/1-12.png)
...
5. 运行程序
   ...
   ![1631255110375](..\图片\4-05【MyBatisPlus】/1-13.png)

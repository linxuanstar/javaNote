...
1. 创建Maven项目。我们创建了一个Maven项目ssm_spring01，然后在该项目下面创建了一个模块spring01。
...
在Spring配置文件中，我们可以配置scope属性来实现bean的非单例创建。`singleton`默认为单例，`prototype`为非单例
...
![1629803529598](D:\Java\笔记\图片\3-1【Spring】\1-14.png)

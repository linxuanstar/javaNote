...
![1629735078619](..\图片\3-2【Spring】\1-7.png)
...
3. 修改配置完成注入，在配置文件中添加依赖注入的配置
   ...
   * `ref="bookDao"`中`bookDao`的作用是让Spring能在IOC容器中找到id为`bookDao`的Bean对象给`bookService`进行注入
   ...
   ![1629736314989](..\图片\3-2【Spring】\1-8.png)
...
![image-20210729183628138](..\图片\3-2【Spring】\1-12.png)
...
6. 构造函数中添加一个参数测试
   ...
   ![1629776331499](..\图片\3-2【Spring】\1-13.png)
...
![1629803529598](..\图片\3-2【Spring】\1-14.png)

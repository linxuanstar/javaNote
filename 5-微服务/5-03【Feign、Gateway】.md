...
2. Feign客户端和Controller都集成改接口
   ...
   ![](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714190640857.png)
...
![image-20210714214041796](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714214041796.png)
...
3. 重启测试
   ...
   ![image-20210714205623048](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714205623048.png)
...
![](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714210131152.png)
...
5. 网关路由的流程图
   ...
   ![image-20210714211742956](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714211742956.png)
...
![image-20210714212312871](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714212312871.png)
...
![image-20210714214228409](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714214228409.png)
...
![image-20210714215713563](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714215713563.png)

放入tomcat或者nginx这样的web服务器中，启动并访问。

可以在浏览器控制台看到下面的错误：

![image-20210714215832675](..\图片\5-03【Nacos配置管理、Feign、Gateway】/image-20210714215832675.png)

...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\1-1.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\1-2.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\1-3.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-1.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-2.png)
...
5. 启动服务
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-3.png)
...
3. 启动多个user-service实例
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-4.png)
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-5.png)
   
   查看eureka-server管理页面：
   
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-6.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\2-7.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-1.png)
...
1. `LoadBalancerIntercepor`
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-2.png)
...
2. `LoadBalancerClient`，继续跟入execute方法。
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-3.png)
   ...
   <img src="..\图片\5-02【Eureka、Ribbon、Nacos】\3-4.png" style="zoom:150%;" />
...
3. 负载均衡策略`IRule`
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-5.png)

   继续跟踪源码chooseServer方法，发现这么一段代码：

   <img src="..\图片\5-02【Eureka、Ribbon、Nacos】\3-6.png" style="zoom:150%;" />

   我们看看这个rule是谁：

   <img src="D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-7.png" style="zoom:150%;"  >

   这里的rule默认值是一个`RoundRobinRule`，看类的介绍：

   <img src="D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-8.png" style="zoom:150%;" />
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-9.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\3-10.png)
...
2. 第二种配置文件方式：在order-service的`application.yml`文件中，添加新的配置也可以修改规则：
...
3. 重启
   ...
   ![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-1.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-2.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-3.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-4.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-5.png)

**创建namespace**

默认情况下，所有service、data、group都在同一个namespace，名为public：

![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-6.png)

我们可以点击页面新增按钮，添加一个namespace：

![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-7.png)

然后，填写表单：

![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-8.png)

就能在页面看到一个新的namespace：

![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-9.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-10.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\4-11.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\5-1.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\5-2.png)
...
![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\5-3.png)

其中包含3个nacos节点，然后一个负载均衡器代理3个Nacos。这里负载均衡器可以使用nginx。

我们计划的集群结构：

![](D:\Java\笔记\图片\5-02【Eureka、Ribbon、Nacos】\5-4.png)

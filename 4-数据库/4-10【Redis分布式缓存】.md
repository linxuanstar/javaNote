...
![](..\图片\4-10【Redis分布式缓存】/image-20210725151319695.png)
...
![image-20210725151543640](..\图片\4-10【Redis分布式缓存】/image-20210725151543640.png)
...
![image-20210725151729118](..\图片\4-10【Redis分布式缓存】/image-20210725151729118.png)
...
![image-20210725151940515](..\图片\4-10【Redis分布式缓存】/image-20210725151940515.png)
...
![image-20210725152037611](..\图片\4-10【Redis分布式缓存】/image-20210725152037611.png)
...
![image-20210725152222497](..\图片\4-10【Redis分布式缓存】/image-20210725152222497.png)
...
![image-20210725152700914](..\图片\4-10【Redis分布式缓存】/image-20210725152700914.png)
...
![image-20210725153201086](..\图片\4-10【Redis分布式缓存】/image-20210725153201086.png)
...
![image-20210725153359022](..\图片\4-10【Redis分布式缓存】/image-20210725153359022.png) 

slave与master的offset之间的差异，就是salve需要增量拷贝的数据了。

随着不断有数据写入，master的offset逐渐变大，slave也不断的拷贝，追赶master的offset：

![image-20210725153524190](..\图片\4-10【Redis分布式缓存】/image-20210725153524190.png) 



直到数组被填满：

![image-20210725153715910](..\图片\4-10【Redis分布式缓存】/image-20210725153715910.png) 
...
![image-20210725153937031](..\图片\4-10【Redis分布式缓存】/image-20210725153937031.png) 

如果master继续写入新数据，其offset就会覆盖旧的数据，直到将slave现在的offset也覆盖：

![image-20210725154155984](..\图片\4-10【Redis分布式缓存】/image-20210725154155984.png) 



棕色框中的红色部分，就是尚未同步，但是却已经被覆盖的数据。此时如果slave恢复，需要同步，却发现自己的offset都没有了，无法完成增量同步了。只能做全量同步。

![image-20210725154216392](..\图片\4-10【Redis分布式缓存】/image-20210725154216392.png)
...
![image-20210725154405899](..\图片\4-10【Redis分布式缓存】/image-20210725154405899.png)
...
![image-20210725154528072](..\图片\4-10【Redis分布式缓存】/image-20210725154528072.png)
...
![image-20210725154632354](..\图片\4-10【Redis分布式缓存】/image-20210725154632354.png)
...
![image-20210725154816841](..\图片\4-10【Redis分布式缓存】/image-20210725154816841.png)
...
<img src="..\图片\4-10【Redis分布式缓存】/image-20210701222857997.png" alt="image-20210701222857997" style="zoom:200%;" />

查看7003的日志：

![image-20210701223025709](..\图片\4-10【Redis分布式缓存】/image-20210701223025709.png)

查看7002的日志：

![image-20210701223131264](..\图片\4-10【Redis分布式缓存】/image-20210701223131264.png)
...
![image-20210725155747294](..\图片\4-10【Redis分布式缓存】/image-20210725155747294.png)
...
![image-20210702181101969](D:\Bprogram\java\黑马程序员\第四阶段\高级篇\day03-分布式缓存\资料\..\图片\4-10【Redis分布式缓存】\image-20210702181101969.png)

这里输入yes，则集群开始创建：

![image-20210702181215705](D:\Bprogram\java\黑马程序员\第四阶段\高级篇\day03-分布式缓存\资料\..\图片\4-10【Redis分布式缓存】\image-20210702181215705.png)
...
![image-20210702181922809](D:\Bprogram\java\黑马程序员\第四阶段\高级篇\day03-分布式缓存\资料\..\图片\4-10【Redis分布式缓存】\image-20210702181922809.png)
...
![image-20210702182343979](D:\Bprogram\java\黑马程序员\第四阶段\高级篇\day03-分布式缓存\资料\..\图片\4-10【Redis分布式缓存】\image-20210702182343979.png)
...
![image-20210702182602145](..\图片\4-10【Redis分布式缓存】\image-20210702182602145.png)
...
![image-20210725155820320](..\图片\4-10【Redis分布式缓存】/image-20210725155820320.png)
...
![image-20210725161007099](..\图片\4-10【Redis分布式缓存】/image-20210725161007099.png)
...
![image-20210727161152065](..\图片\4-10【Redis分布式缓存】/image-20210727161152065.png)
...
![image-20210725162319490](..\图片\4-10【Redis分布式缓存】/image-20210725162319490.png)

3）最后是确定下线，自动提升一个slave为新的master：

![image-20210725162408979](..\图片\4-10【Redis分布式缓存】/image-20210725162408979.png)

4）当7002再次启动，就会变为一个slave节点了：

![image-20210727160803386](..\图片\4-10【Redis分布式缓存】/image-20210727160803386.png)
...
![image-20210725162441407](..\图片\4-10【Redis分布式缓存】/image-20210725162441407.png)
...
![image-20210727160037766](..\图片\4-10【Redis分布式缓存】/image-20210727160037766.png)
